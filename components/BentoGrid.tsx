...
import { Calendar, Sparkles, BarChart3, Youtube, Bot, Layers } from 'lucide-react';
    ...
    <section id="funcionalidades" className="py-24 px-4 relative z-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[200px]">
          {features.map((f, i) => (
            <TiltCard key={i} className={`${f.col} p-8 flex flex-col justify-between group`}>
              <div className="flex justify-between items-start">
                <div className={`p-3 bg-white/5 rounded-xl ${f.color}`}>
